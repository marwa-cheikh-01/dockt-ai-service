...
# 3. La route principale qui reçoit l'audio d'Angular et renvoie le texte
...
def transcribe_audio():
    ...
    try:
        # Vérification 1 : Est-ce qu'Angular a bien envoyé un fichier "audio" ?
        ...
        # Vérification 2 : Si le fichier est vide (0 octet), on annule
        ...
        # S'il y a un bug, on supprime quand même le fichier pour ne pas polluer le PC
        if os.path.exists(temp_path):
            os.remove(temp_path)
